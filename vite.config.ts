            ...
            if (req.url?.startsWith("/api/analyze") && req.method === "POST") {
              ...
              req.on("end", async () => {
                try {
                  ...
                  const prompt = `Analise o seguinte conteúdo para uma rede social e verifique se ele fere as diretrizes da comunidade (ódio, violência, pornografia, spam, assédio). 
