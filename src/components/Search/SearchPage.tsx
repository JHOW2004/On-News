...
const SearchPage: React.FC<SearchPageProps> = ({ onUserClick }) => {
  ...
  return (
    <div>
        ...
        <form onSubmit={handleSearch} className="relative">
          <div className="relative">
            ...
            <input
              ...
              placeholder={searchType === 'news' ? "Pesquisar notícias..." : "Pesquisar usuário (username)..."}
      ...
      {searchType === 'news' ? (
         activeSearch ? <NewsFeed searchQuery={activeSearch} onUserClick={onUserClick} /> : null
      ) : (
        <div className="space-y-4">
          {loadingUsers && <div className="text-center">Pesquisando usuários...</div>}
