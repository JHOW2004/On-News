...
import { Home, Grid3x3 as Grid3X3, User, Activity, Search, Sun, Moon, LogOut } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeItem, onItemChange }) => {
  ...
  const navigationItems = [
    ...
    { id: 'my-actions' as NavigationItem, label: 'Minhas Ações', icon: Activity },
  ];
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              ...
              <span className="text-sm">{theme === 'light' ? 'Escuro' : 'Claro'}</span>
            </button>
